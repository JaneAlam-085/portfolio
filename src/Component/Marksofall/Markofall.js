...
export default function Markofall() {
  return (
    ...
    <table class="w-full text-sm text-left rtl:text-right text-gray-700 dark:text-gray-400">
        <thead class="text-lg text-white font-bold uppercase bg-gray-700 dark:bg-gray-700 dark:text-gray-400">
            <tr>
        ...
        <tbody>
            <tr class="odd:bg-gray-300 odd:dark:bg-gray-900  even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
